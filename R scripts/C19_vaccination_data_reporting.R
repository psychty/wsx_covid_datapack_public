...
libraries("readxl", "readr", "plyr", "dplyr", "ggplot2", "png", "tidyverse", 'scales', 'zoo', 'stats',"rgdal", 'rgeos', "tmaptools", 'sp', 'sf', 'maptools', 'leaflet', 'leaflet.extras', 'spdplyr', 'geojsonio', 'rmapshaper', 'jsonlite', 'grid', 'aweek', 'xml2', 'rvest', 'officer', 'flextable', 'viridis', 'epitools', 'patchwork', 'lemon', 'PostcodesioR')
...
mye_nims_msoa <- read_csv(paste0(github_repo_dir, '/Source files/msoa_nims_pop_estimates.csv')) %>% 
  mutate(Population_5_and_over = Age_5_and_over) %>% 
...
vaccine_df_msoa <- read_excel(paste0(github_repo_dir,'/Source files/nhs_e_vaccines.xlsx'),
                              sheet = 'MSOA',
                              skip = 15,
                              col_names = c('Region_code', 'Region_name', 'LTLA_code', 'LTLA_name', 'msoa11cd', 'msoa11nm', 'First_dose_5_11', 'First_dose_12_15', 'First_dose_16_17',  'First_dose_age_18_24', 'First_dose_age_25_29', 'First_dose_age_30_34', 'First_dose_age_35_39', 'First_dose_age_40_44', 'First_dose_age_45_49', 'First_dose_age_50_54', 'First_dose_age_55_59', 'First_dose_age_60_64', 'First_dose_age_65_69', 'First_dose_age_70_74', 'First_dose_age_75_79', 'First_dose_age_80_and_over', 'First_dose_under_12_unknown', 'Null_1', 'Second_dose_12_15', 'Second_dose_16_17', 'Second_dose_age_18_24',  'Second_dose_age_25_29', 'Second_dose_age_30_34', 'Second_dose_age_35_39', 'Second_dose_age_40_44', 'Second_dose_age_45_49', 'Second_dose_age_50_54', 'Second_dose_age_55_59', 'Second_dose_age_60_64', 'Second_dose_age_65_69', 'Second_dose_age_70_74', 'Second_dose_age_75_79', 'Second_dose_age_80_and_over', 'Null_2', 'Third_dose_under_18', 'Third_dose_18_24', 'Third_dose_25_29', 'Third_dose_30_34', 'Third_dose_35_39', 'Third_dose_40_44', 'Third_dose_45_49', 'Third_dose_50_54', 'Third_dose_55_59', 'Third_dose_60_64', 'Third_dose_65_69', 'Third_dose_70_74', 'Third_dose_75_79', 'Third_dose_80_and_over', 'Null_3','Total_doses')) %>% 
  filter(!is.na(Region_name)) %>% 
  mutate(Age_5_and_over = as.numeric(First_dose_5_11) + as.numeric(First_dose_12_15) + as.numeric(First_dose_16_17) + as.numeric(First_dose_age_18_24) + First_dose_age_25_29 + First_dose_age_30_34 + First_dose_age_35_39 + First_dose_age_40_44 + First_dose_age_45_49 + First_dose_age_50_54 + First_dose_age_55_59 + First_dose_age_60_64 + First_dose_age_65_69 + First_dose_age_70_74 + First_dose_age_75_79 + First_dose_age_80_and_over) %>% 
  ...
  mutate(Age_5_and_over_banded = factor(ifelse(Age_5_and_over < 1000, 'Up to 999', ifelse(Age_5_and_over < 2000, '1,000-1,999', ifelse(Age_5_and_over < 3000, '2,000-2,999', ifelse(Age_5_and_over < 4000, '3,000-3,999', ifelse(Age_5_and_over < 5000, '4,000-4,999',  ifelse(Age_5_and_over < 6000, '5,000-5,999',  ifelse(Age_5_and_over < 7000, '6,000-6,999', '7,000+'))))))), levels = c('Up to 999', '1,000-1,999', '2,000-2,999', '3,000-3,999', '4,000-4,999', '5,000-5,999', '6,000-6,999', '7,000+'))) %>%
  ...
  arrange(msoa11cd) %>% 
  left_join(mye_nims_msoa[c('msoa11cd', 'Population_5_and_over', 'Population_12_and_over', 'Population_16_and_over','Population_18_and_over',  'Population_50_and_over', 'Population_65_and_over', 'Population_18_64')], by = 'msoa11cd') %>% 
  mutate(Proportion_5_and_over = Age_5_and_over/ Population_5_and_over) %>% 
  ...
  mutate(Proportion_5_and_over_banded = factor(ifelse(Proportion_5_and_over < .1, 'Less than 10%', ifelse(Proportion_5_and_over < .2, '10-19%',ifelse(Proportion_5_and_over < .3, '20-29%', ifelse(Proportion_5_and_over < .4, '30-39%', ifelse(Proportion_5_and_over < .5, '40-49%', ifelse(Proportion_5_and_over < .6, '50-59%', ifelse(Proportion_5_and_over < .7, '60-69%', ifelse(Proportion_5_and_over < .8, '70-79%', ifelse(Proportion_5_and_over < .9, '80-89%', ifelse(Proportion_5_and_over < 1, '90-99%', '100% of estimated population')))))))))), levels = c('Less than 10%', '10-19%', '20-29%', '30-39%', '40-49%', '50-59%', '60-69%', '70-79%', '80-89%', '90-99%', '100% of estimated population'))) %>% 
  ...
  mutate(Estimated_left_to_vaccinate_5_and_over = Population_5_and_over - Age_5_and_over,
         Estimated_left_to_vaccinate_12_and_over = Population_12_and_over - Age_12_and_over,
