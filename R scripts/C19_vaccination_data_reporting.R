...
mye_nims_msoa <- read_csv(paste0(github_repo_dir, '/Source files/msoa_nims_pop_estimates.csv')) %>% 
  mutate(Population = `Under_18` + `Age_18_and_over`) %>% 
...
vaccine_df_msoa <- read_excel(paste0(github_repo_dir,'/Source files/nhs_e_vaccines.xlsx'),
  ...
  mutate(Total_where_age_known = as.numeric(First_dose_under_18) + as.numeric(First_dose_age_18_24) + First_dose_age_25_29 + First_dose_age_30_34 + First_dose_age_35_39 + First_dose_age_40_44 + First_dose_age_45_49 + First_dose_age_50_54 + First_dose_age_55_59 + First_dose_age_60_64 + First_dose_age_65_69 + First_dose_age_70_74 + First_dose_age_75_79 + First_dose_age_80_and_over) %>% 
  ...
  mutate(Total_age_18_banded = factor(ifelse(Age_18_and_over < 1000, 'Up to 999', ifelse(Age_18_and_over < 2000, '1,000-1,999', ifelse(Age_18_and_over < 3000, '2,000-2,999', ifelse(Age_18_and_over < 4000, '3,000-3,999', ifelse(Age_18_and_over < 5000, '4,000-4,999',  '5,000+'))))), levels = c('Up to 999', '1,000-1,999', '2,000-2,999', '3,000-3,999', '4,000-4,999', '5,000+'))) %>%
  ...
  arrange(msoa11cd) %>% 
  left_join(mye_nims_msoa[c('msoa11cd',  'Population_18_and_over', 'Population_65_and_over', 'Population_18_64')], by = 'msoa11cd') %>% 
  mutate(Proportion_age_known = Total_where_age_known/ Population_18_and_over) %>% 
  mutate(Proportion_18_plus = Age_18_and_over/Population_18_and_over) %>% 
  ...
  mutate(Proportion_18_plus_banded = factor(ifelse(Proportion_18_plus < .7, 'Less than 70%', ifelse(Proportion_18_plus < .75, '70-74%', ifelse(Proportion_18_plus < .8, '75-79%',ifelse(Proportion_18_plus < .85, '80-84%', ifelse(Proportion_18_plus < .9, '85-89%', ifelse(Proportion_18_plus < .95, '90-94%', ifelse(Proportion_18_plus < 1, '95-99%', '100% of estimated population'))))))), levels = c('Less than 70%', '70-74%', '75-79%', '80-84%', '85-89%', '90-94%', '95-99%', '100% of estimated population'))) %>% 
  ...
  mutate(Estimated_left_to_vaccinate_18_plus = Population_18_and_over - Age_18_and_over,
  ...
  select(msoa11cd, msoa11hclnm, LTLA_name, Total_where_age_known, Proportion_age_known, Total_banded, Proportion_age_known_banded, Age_18_and_over, Proportion_18_plus, Total_age_18_banded, Proportion_18_plus_banded, Estimated_left_to_vaccinate_18_plus, Age_65_and_over, Proportion_65_plus, Total_age_65_banded, Proportion_65_plus_banded, Estimated_left_to_vaccinate_65_plus, Age_18_64, Proportion_18_64, Total_Age_18_64_banded, Proportion_18_64_banded, Estimated_left_to_vaccinate_18_64, Pop_weighted_imd_score, National_pop_weighted_rank, National_pop_weighted_decile, Rank_in_Sussex, Decile_in_Sussex, RUC11, Total_doses) 

vaccine_df_msoa %>% 
  group_by(LTLA_name) %>% 
  mutate(Proportion_rank_18_plus_within_LTLA = rank(desc(Proportion_18_plus))) %>% 
  ...
  select(LTLA_name, MSOA_name, Total_where_age_known, Age_18_and_over, Proportion_rank_18_plus_within_LTLA, Proportion_18_plus, Estimated_left_to_vaccinate_18_plus, Age_65_and_over, Proportion_rank_65_plus_within_LTLA,Proportion_65_plus, Estimated_left_to_vaccinate_65_plus, Pop_weighted_imd_score, National_pop_weighted_decile, Decile_in_Sussex, National_pop_weighted_rank, Rank_in_Sussex, msoa11cd, Proportion_age_known, Proportion_18_64, Age_18_64) %>% 
  ...
  arrange(LTLA_name, Proportion_rank_18_plus_within_LTLA) %>% 
  toJSON() %>% 
...
#   left_join(mye_nims_ltla[c('LTLA_code', 'Age_18_and_over', 'Population_30_and_over', 'Population_65_and_over', 'Population_30_64')], by = 'LTLA_code') %>% 
#   mutate(First_dose_proportion_age_known = Total_first_dose_where_age_known/ Age_18_and_over) %>% 
...
#   select(LTLA_code, LTLA_name, Total_first_dose_where_age_known, First_dose_proportion_age_known, First_dose_age_30_and_over, First_dose_proportion_30_plus, Age_18_and_over, Population_30_and_over, First_dose_age_65_and_over, First_dose_proportion_65_plus, Population_65_and_over, First_dose_age_30_64, First_dose_proportion_30_64, Population_30_64) %>% 
#   rename(Population_18_and_over = Age_18_and_over)
# 
...
#             Population_18_and_over = sum(Population_18_and_over),
...
#          LTLA_code = 'E10000032') %>%
#   mutate(First_dose_proportion_age_known = Total_first_dose_where_age_known/ Population_18_and_over) %>% 
#   mutate(First_dose_proportion_30_plus = First_dose_age_30_and_over/Population_30_and_over) %>%
#   mutate(First_dose_proportion_65_plus = First_dose_age_65_and_over/Population_65_and_over) %>%
#   mutate(First_dose_proportion_30_64 = First_dose_age_30_64/Population_30_64) %>% 
#   select(LTLA_code, LTLA_name, Total_first_dose_where_age_known, First_dose_proportion_age_known, First_dose_age_30_and_over, First_dose_proportion_30_plus, Population_18_and_over, Population_30_and_over, First_dose_age_65_and_over, First_dose_proportion_65_plus, Population_65_and_over, First_dose_age_30_64, First_dose_proportion_30_64, Population_30_64) 
# 
# # Add SE and England
# 
...
#   mutate(First_dose_age_65_and_over = First_dose_age_65_69 + First_dose_age_70_74 + First_dose_age_75_79 + First_dose_age_80_and_over) %>% 
#   mutate(First_dose_age_30_64 = First_dose_age_30_34 + First_dose_age_35_39 + First_dose_age_40_44 + First_dose_age_45_49 + First_dose_age_50_54 + First_dose_age_55_59 + First_dose_age_60_64) %>% 
#   left_join(mye_ons_region[c('Region_name', 'Age_18_and_over', 'Population_30_and_over', 'Population_65_and_over', 'Population_30_64')], by = 'Region_name') %>% 
#   mutate(First_dose_proportion_age_known = Total_first_dose_where_age_known/ Age_18_and_over) %>% 
#   mutate(First_dose_proportion_30_plus = First_dose_age_30_and_over/Population_30_and_over) %>% 
#   mutate(First_dose_proportion_65_plus = First_dose_age_65_and_over/Population_65_and_over) %>% 
#   mutate(First_dose_proportion_30_64 = First_dose_age_30_64/Population_30_64) %>% 
#   select(Region_name, Total_first_dose_where_age_known, First_dose_proportion_age_known, First_dose_age_30_and_over, First_dose_proportion_30_plus, Age_18_and_over, Population_30_and_over, First_dose_age_65_and_over, First_dose_proportion_65_plus, Population_65_and_over, First_dose_age_30_64, First_dose_proportion_30_64, Population_30_64) %>% 
#   rename(Population_18_and_over = Age_18_and_over) %>% 
...
#   select(Name, Total_first_dose_where_age_known, First_dose_proportion_age_known, First_dose_age_30_and_over, First_dose_proportion_30_plus, Population_18_and_over, Population_30_and_over, First_dose_age_65_and_over, First_dose_proportion_65_plus, Population_65_and_over, First_dose_age_30_64, First_dose_proportion_30_64, Population_30_64) %>% 
#   toJSON() %>% 
...
#   select(!c('Population', 'Age_18_and_over', 'Population_30_and_over')) %>% 
#   pivot_longer(cols = !c('LTLA_code', 'LTLA_name'), values_to = 'NIMS_population') %>% 
#   rename(Age_group = 'name') %>% 
#   mutate(Age_group = ifelse(Age_group == 'Age_18_29', 'Under_30', Age_group)) %>% 
...
vaccine_df_msoa_age <- read_excel(paste0(github_repo_dir,'/Source files/nhs_e_vaccines.xlsx'),
                                  sheet = 'MSOA',
                                  skip = 15,
                                  col_names = c('Region_code', 'Region_name', 'LTLA_code', 'LTLA_name', 'msoa11cd', 'msoa11nm', 'First_dose_under_18', 'First_dose_age_18_24', 'First_dose_age_25_29', 'First_dose_age_30_34', 'First_dose_age_35_39', 'First_dose_age_40_44', 'First_dose_age_45_49', 'First_dose_age_50_54', 'First_dose_age_55_59', 'First_dose_age_60_64', 'First_dose_age_65_69', 'First_dose_age_70_74', 'First_dose_age_75_79', 'First_dose_age_80_and_over', 'Null_1', 'Second_dose_under_18', 'Second_dose_18_24', 'Second_dose_age_25_29', 'Second_dose_age_30_34', 'Second_dose_age_35_39', 'Second_dose_age_40_44', 'Second_dose_age_45_49', 'Second_dose_age_50_54', 'Second_dose_age_55_59', 'Second_dose_age_60_64', 'Second_dose_age_65_69', 'Second_dose_age_70_74', 'Second_dose_age_75_79', 'Second_dose_age_80_and_over', 'Null_2', 'Total_doses')) %>% 
  mutate(First_dose_under_18 = as.numeric(First_dose_under_18),
         First_dose_age_18_24 = as.numeric(First_dose_age_18_24)) %>% 
  filter(!is.na(Region_name)) %>% 
  select(!c( 'Null_1', 'Second_dose_under_18', 'Second_dose_18_24','Second_dose_age_25_29', 'Second_dose_age_30_34', 'Second_dose_age_35_39',  'Second_dose_age_40_44', 'Second_dose_age_45_49', 'Second_dose_age_50_54', 'Second_dose_age_55_59', 'Second_dose_age_60_64', 'Second_dose_age_65_69', 'Second_dose_age_70_74', 'Second_dose_age_75_79', 'Second_dose_age_80_and_over', 'Null_2', 'Total_doses')) %>% 
