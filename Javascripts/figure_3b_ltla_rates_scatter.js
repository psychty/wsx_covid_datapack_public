...
var ltla_area_growth_comp = ['Adur', 'Arun', 'Chichester', 'Crawley', 'Horsham', 'Mid Sussex', 'Worthing', 'Other ltlas', 'England'];
...
ltla_growth_ts_line
  ...
  .attr('y2', function (d) { return y_growth_ltla_ts(0); } )
  .attr('stroke', '#000000')
...
// Add Y axis
var y_growth_ltla_ts = d3.scaleLinear()
   .domain([-1, d3.max(chosen_time_ltla_df, function(d) { return +d.Change_actual_by_week; })])
